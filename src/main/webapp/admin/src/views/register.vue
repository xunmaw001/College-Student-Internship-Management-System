  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(247, 240, 240, 0.7);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">高校学生实习管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="学校" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.xuexiao" autocomplete="off" placeholder="学校"  />
			</el-form-item>
			<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">班级</div>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201211/169c811be33341d38723a36ccf3d729f.jpg");
		height: 100vh;
