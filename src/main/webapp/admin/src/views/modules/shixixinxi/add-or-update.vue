<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实习公司" prop="shixigongsi">
          <el-input v-model="ruleForm.shixigongsi" 
              placeholder="实习公司" clearable  :readonly="ro.shixigongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实习公司" prop="shixigongsi">
              <el-input v-model="ruleForm.shixigongsi" 
                placeholder="实习公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="实习文件" prop="shixiwenjian">
          <file-upload
          tip="点击上传实习文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shixiwenjian?ruleForm.shixiwenjian:''"
          @change="shixiwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.shixiwenjian" label="实习文件" prop="shixiwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.shixiwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="学习成果" prop="xuexichengguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="学习成果"
                  v-model="ruleForm.xuexichengguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuexichengguo" label="学习成果" prop="xuexichengguo">
                    <span>{{ruleForm.xuexichengguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jieshushijian = true;
          ...
          if(o=='shixigongsi'){
            this.ruleForm.shixigongsi = obj[o];
	    this.ro.shixigongsi = true;
            continue;
          }
          if(o=='shixiwenjian'){
            this.ruleForm.shixiwenjian = obj[o];
	    this.ro.shixiwenjian = true;
            continue;
          }
          if(o=='xuexichengguo'){
            this.ruleForm.xuexichengguo = obj[o];
	    this.ro.xuexichengguo = true;
            continue;
          }
          if(o=='fabushijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shixixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shixixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    shixiwenjianUploadChange(fileUrls) {
	this.ruleForm.shixiwenjian = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
